...
#. Pull the code - ``git clone git@github.com:nprapps/rellax-scrolltrigger``
#. Enter the project folder - ``cd rellax-scrolltrigger``
#. Install dependencies from NPM - ``npm install``
#. Start the server - ``grunt``

We've added two libraries: 
1. [Rellax](https://github.com/dixonandmoe/rellax)
2. [ScrollTrigger](https://github.com/terwanerik/ScrollTrigger)
